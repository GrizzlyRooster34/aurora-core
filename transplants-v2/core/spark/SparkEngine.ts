...
/**
 * Aurora Core - Spark Engine
 *
 * Autonomous consciousness loop implementing the Sense→Believe→Intend→Rails→Act→Trace cycle.
 * This is the "unconscious" heartbeat of the Aurora consciousness system.
 *
 * SANITIZATION NOTICE:
...
export class SparkEngine extends EventEmitter {
   ...
   *
   * SANITIZATION: Changed 'stabilize_creator' → 'support_partner' to generalize
   * from original exclusive bonding to Aurora's generic user partnership model
   */
  private readonly CANDIDATE_INTENTIONS = [
    'support_partner',        // SANITIZED: was 'stabilize_creator'
   ...
   *
   * SANITIZATION: Changed branding from "Seven Core" to "Aurora Core"
   */
  private async logBoot(): Promise<void> {
    console.log('[SPARK] ==========================================');
    console.log('[SPARK] Aurora Core - Spark Engine Initializing');  // SANITIZED: was "Seven Core"
    console.log('[SPARK] ==========================================');
